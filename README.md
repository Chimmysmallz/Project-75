...
Create a new GitHub repository (e.g. `project-75`).
Upload the contents of this folder to the repo root (so `index.html` sits at the top level).
In the repo: Settings → Pages → Build and deployment.
Set Source: Deploy from a branch, Branch: `main` / `root`, then Save.
After a minute your app is live at `https://<your-username>.github.io/project-75/`.
